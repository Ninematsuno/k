...
from nksama import SUDOS, bot
from nksama.core.decorators.errors import capture_err
from nksama.modules.trust import get_spam_probability
...
@bot.on_message(filters.command("chat_info"))
@capture_err
